...
<div id="main_div">
    ...
    <h3>Edit Video</h3>	
	 <form method="post" action="edit_video_ex.php" >
    		<input type="hidden" name="id_video" value="<?php echo $id;?>">
            <label for="title_video">Title</label>
            <input type="text" name="title_video" id="title_video" class="text_input" value="<?php echo $title; ?>"/><br/>
            ...
            <select id = "cat_video"  name="cat_video" class="text_input">
            <?php
            ...
            <input type="submit" name="edit_video" id="edit_video"/>
            <a href="videos_list.php"> Back</a>
